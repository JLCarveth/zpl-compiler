...
/**
 * @brief Matches the <varlistPrime> non-terminal
 * BNF: <varlistPrime> -> , <identifier> <varlistPrime>
 *                      | ε
 */
zero_null varlistPrime() {
  switch (lookahead.code) {
  case ID_T:
    matchToken(SEP_T, COMMA);
    matchToken(ID_T, NO_ATTR);
    varlistPrime();
    break;
  default:; // Empty
 ...
 * FIRST(<opt_varlist_declarations>) = { e, KW_T (INT), KW_T (FLOAT), KW_T
 *(STRING)}.
 ************************************************************/
zero_null optVarListDeclarations() {
  ...
  ; // Empty
  printf("%s%s\n", STR_LANGNAME,
         ": Optional Variable List Declarations parsed");
}
 ...
 ************************************************************/
zero_null optionalStatements() { // TO_DO: Basic implementation
  switch (lookahead.code) {
  case KW_T:
  case ID_T:
    statements();
 ...
 * BNF: <logical-OR-expression> -> <logical-AND-expression>
 ...
 * BNF: <logical-OR-expressionPrime> -> || <logical-AND-expression>
 * <logical-OR-expressionPrime> | ϵ
 * @return zero_null
 */
...
/**
 * @brief Matches the <logical-AND-expression> non-terminal
...
/**
 * @brief Matches the <logical-AND-expressionPrime> non-terminal
 * BNF: <logical-AND-expressionPrime> -> || <logical-NOT-expression>
 * <logical-AND-expressionPrime> | ϵ
 * @return zero_null
 */
